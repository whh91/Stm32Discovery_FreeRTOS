...
C_SRCS += \
../FreeRTOS/Settings/demo/Common/drivers/LuminaryMicro/ustdlib.c 

OBJS += \
./FreeRTOS/Settings/demo/Common/drivers/LuminaryMicro/ustdlib.o 

C_DEPS += \
./FreeRTOS/Settings/demo/Common/drivers/LuminaryMicro/ustdlib.d 


# Each subdirectory must supply rules for building sources it contributes
FreeRTOS/Settings/demo/Common/drivers/LuminaryMicro/%.o: ../FreeRTOS/Settings/demo/Common/drivers/LuminaryMicro/%.c
	@echo 'Building file: $<'
